...
const PatientForm = ({ isSearchEnabled = false }: PatientFormProps) => {
    ...
    <div className="bg-white p-4 rounded-md">
      ...
      <div className="grid grid-cols-3 gap-4 mb-4">
        <div>
          ...
          <Input id="diagnosis" className="h-9" />
        </div>
        <div>
          <Label htmlFor="amount" className="mb-1 block">Amount:</Label>
          <Input id="amount" className="h-9" type="number" />
        </div>
        <div></div>
      </div>
      ...
      <div className="grid grid-cols-3 gap-4 mb-4">
        ...
        <div>
          ...
          <Select>
            ...
            <SelectContent>
              <SelectItem value="E.W.B">E.W.B</SelectItem>
              <SelectItem value="F.F.P">F.F.P</SelectItem>
              <SelectItem value="R.D.P">R.D.P</SelectItem>
      ...
      <div className="grid grid-cols-3 gap-4 mb-4">
        <div>
          ...
          <Input id="weight" className="h-9" type="number" defaultValue="0.00" />
        </div>
        <div>
        ...
        <div className="grid grid-cols-2 gap-2">
          <div>
            ...
            <div className="flex items-center">
              <Input id="bottle" className="h-9 rounded-r-none" type="number" defaultValue="0" />
          ...
          <div>
            ...
            <Input id="required" className="h-9" />
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-4 mb-4">
        <div>
          ...
          <Input id="dob" className="h-9" type="date" />
        </div>
        <div>
          <Label htmlFor="expDate" className="mb-1 block">Exp Date:</Label>
          <Input id="expDate" className="h-9" type="date" />
        </div>
      </div>
